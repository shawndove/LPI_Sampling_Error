...
dir.create(paste("TestData/", iter_num, sep="")) # create a new directory to put files
setwd(paste("TestData/", iter_num, sep="")) # set the new directory as working directory
